 ...
 */
const STATUS_BASE = {
  // ✅ 4 ขั้น: รอตรวจสอบ → ตรวจสอบแล้ว รออนุมัติ → อนุมัติแล้ว รออนุมัติเบิกจ่าย → จ่าย/ปิดรายการ
...
export const statusMeta = (status, kind) => {
  ...
  if (status === "approved") {
    // ✅ ขั้นที่ 4 จาก 4 — ทุกชนิดใบรอ "อนุมัติเบิกจ่าย" (ผู้จัดการแผนกช่าง/กรรมการผู้จัดการ)
