...
// shared/utils/contractOverdue.js แล้วตั้งแต่ก่อนหน้านี้ (ใช้ซ้ำที่ Header.js ด้วยสำหรับป้ายบนแถบเมนู) กันตรรกะ
...
const Dashboard = () => {
  ...
  // ✅ ใช้ util กลาง (src/shared/utils/overdueJobs.js) แทนโค้ดจัดกลุ่ม/คิดค้างแบบ inline เดิม — ตรรกะ
  ...
  // แทนทั้งหมด (ดู shared/utils/quotationTracking.js) ตัวเลข/เงื่อนไขจึงตรงกันทุกจุดเสมอ และการบันทึกติดตาม
  ...
  // ใช้ groupEventsByContract + nextVisitOverdueInfo ตัวเดียวกันเป๊ะๆ (shared/utils/contractOverdue.js) กัน
