...
const GROUPS = [
  {
    ...
    items: [
      ["viewAllJobs", "เห็นงานของทุกคน ทั้งฝ่ายบริการและฝ่ายขาย",
        "ไม่ติ๊ก = เห็นเฉพาะงานที่ตัวเองสร้างหรือถูกระบุเป็นผู้รับผิดชอบ — เช่น ช่างเทคนิคจะเห็นแค่งานของตัวเองในปฏิทิน แดชบอร์ด และรายการใบเสนอราคา"],
      ["viewServiceCalendar", "เปิดเมนู ปฏิทินงาน > ฝ่ายบริการ (คิวงานช่าง) ได้",
        "เปิดดูคิวช่างได้อย่างเดียว — จะเพิ่ม/แก้/ย้ายงานของฝ่ายบริการต้องติ๊ก “แก้ไขงานของคนอื่น” เพิ่ม · ช่องนี้มีไว้ให้เซลเช็กคิวช่างก่อนนัดลูกค้า (ปฏิทินฝ่ายขายเปิดได้อยู่แล้วโดยไม่ต้องใช้สิทธิ์นี้)"],
      ["editAnyJob", "แก้ไข / ย้ายวัน / ลบงานของคนอื่นได้ทั้ง 2 ปฏิทิน",
        "ไม่ติ๊ก = แก้ได้เฉพาะงานที่ตัวเองสร้างหรือเป็นผู้รับผิดชอบ งานคนอื่นกดแก้ไม่ได้"],
      ["editOperation", "เปิดเมนู “การดำเนินงาน” และอัปเดตสถานะ/ความคืบหน้า/รูปหน้างาน",
        "ช่างที่ติ๊ก “ถูกมอบหมายงานได้” เข้าหน้านี้ได้อยู่แล้วแต่อัปเดตได้เฉพาะงานที่ตัวเองรับ · ติ๊กช่องนี้ = อัปเดตได้ทุกงานที่มองเห็น"],
      ["approveJobs", "อนุมัติแผนงาน และอนุมัติคำขอปิดงานในปฏิทิน",
        "ไม่ติ๊ก = สร้างงานและกดขอปิดงานได้ แต่งานจะค้างอยู่จนกว่าคนที่มีสิทธิ์นี้จะกดอนุมัติ"],
    ],
  },
  {
    ...
    items: [
      ["requestDispatch", "เปิดใบขอลงงานถึงฝ่ายบริการ (เมนู “คำขอลงงานของฉัน”)",
        "เห็นเฉพาะคำขอที่ตัวเองเปิด — คำขอของคนอื่นไม่เห็น และมอบหมายช่างเองไม่ได้"],
      ["assignDispatch", "เปิดเมนู “คิวคำขอลงงาน” จัดคิว และเลือกช่างผู้รับงาน",
        "เห็นคำขอของทุกคนในบริษัท ไม่ใช่แค่ของตัวเอง · รวมถึงแก้ไข ยกเลิก หรือปิดคำขอของคนอื่น"],
      ["receiveDispatch", "ถูกเลือกเป็นผู้รับงานได้ และอัปเดตเฉพาะงานที่ตัวเองรับ",
        "สำหรับช่างหน้างาน — ไม่ติ๊ก = ชื่อไม่ขึ้นในรายชื่อให้เลือกตอนมอบหมายงาน"],
    ],
  },
  {
    ...
    items: [
      ["editDocuments", "ออกเลขที่เอกสาร และแก้เอกสารที่ออกไปแล้ว (ใบส่งมอบงาน · ใบแจ้งหนี้ · ใบเสร็จ)",
        "ไม่ติ๊ก = เปิดดูและสั่งพิมพ์ได้อย่างเดียว ออกเลขที่ใหม่หรือแก้ของเดิมไม่ได้"],
      ["viewFinance", "เปิดเมนู “การเงิน” (ใบเสนอราคา · ติดตามวางบิล · ติดตามการชำระเงิน)",
        "เปิดดูอย่างเดียว · ไม่ติ๊ก = เมนูการเงินหายไปทั้งหมด และพิมพ์ลิงก์ /finance เองก็ถูกปฏิเสธ"],
      ["editFinance", "แก้สถานะใบเสนอราคา บันทึกวางบิล และบันทึกรับเงิน",
        "ต้องติ๊ก “เปิดเมนูการเงิน” คู่กันเสมอ — ติ๊กแต่ช่องนี้อย่างเดียวจะเข้าหน้าไม่ได้"],
      ["viewContracts", "เปิดเมนู “สัญญาบริการ” ดูสัญญาและรอบเข้า PM ของลูกค้า",
        "เปิดดูอย่างเดียว รวมถึงเห็นว่ารอบไหนถึงกำหนดเข้าบริการ"],
      ["editContracts", "สร้าง / แก้ / ต่ออายุสัญญา และกำหนดรอบเข้าบริการ (PM)",
        "ต้องติ๊ก “เปิดเมนูสัญญาบริการ” คู่กันเสมอ"],
      ["createSalesPlan", "เปิดเมนู “งานขาย” สร้างงานขายและนัดหมายลูกค้าในปฏิทินฝ่ายขาย",
        "คนละปฏิทินกับคิวงานช่าง — ไม่ติ๊ก = เมนูงานขายหายไปทั้งหมด"],
    ],
  },
  {
    ...
    items: [
      ["requestExpense", "ส่วนที่ 1 — ออกใบเบิกล่วงหน้า (Advance) และใบเคลมของตัวเอง",
        "เห็นและแก้ได้เฉพาะใบของตัวเอง และเฉพาะตอนที่ยังไม่ถูกตรวจสอบ — ใบของคนอื่นไม่เห็น"],
      ["reviewExpense", "ส่วนที่ 2 (มือแรก) — ตรวจสอบใบเบิกของคนอื่นก่อนส่งให้อนุมัติ",
        "ตรวจเสร็จ ระบบแจ้งเตือนคนที่มีสิทธิ์อนุมัติทันที — คนตรวจกับคนอนุมัติต้องเป็นคนละคน"],
      ["approveExpense", "ส่วนที่ 2 (มือสอง) — อนุมัติใบเบิกที่ผ่านการตรวจสอบแล้ว",
        "อนุมัติแล้วเงินยังไม่ออก — การจ่ายจริงอยู่ที่ส่วนที่ 3"],
      ["disburseExpense", "ส่วนที่ 3 — อนุมัติเบิกจ่าย ยืนยันว่าจ่ายเงินให้ผู้ขอแล้วจริง",
        "ขั้นสุดท้ายของสาย · กดแล้วระบบเริ่มนับกำหนดเคลียร์ Advance ตามจำนวนวันที่ตั้งไว้ใน ตั้งค่าองค์กร"],
      ["viewAllExpenses", "เห็นใบเบิกของทุกคน ออกใบเบิกแทนคนอื่น และเปิดรายงานสรุปค่าใช้จ่าย",
        "ไม่ติ๊ก = เห็นเฉพาะใบเบิกของตัวเอง (เช่น ช่างเทคนิคเห็นแค่ใบที่ตัวเองเบิก)"],
    ],
  },
  {
    title: "ข้อมูลหลัก",
    items: [
      ["manageMasterData", "จัดการทะเบียนลูกค้า · ประเภท/ระบบงาน · ทีมช่าง · ลายเซ็นในเอกสาร",
        "ไม่รวมการเพิ่ม/ลบผู้ใช้ และการตั้งค่าระบบ — สองอย่างนั้นกำหนดด้วย Role ที่แท็บแรก"],
    ],
  },
];
                  ...
                  <Box component="tr">
                    <Box component="th" sx={{ position: "sticky", left: 0, zIndex: 2, bgcolor: "#f8fafc", textAlign: "left", p: 1.25, borderBottom: `1px solid ${BORDER}`, minWidth: 260, fontSize: "0.85rem" }}>
                      ...
                      <Typography variant="caption" sx={{ display: "block", color: TEXT_SUB, fontWeight: 500 }}>
                        ☑ = ทำได้ · ☐ = ซ่อนเมนู/ปุ่มนั้น และถึงพิมพ์ URL เองเซิร์ฟเวอร์ก็ปฏิเสธ
                      </Typography>
                    </Box>
                    {ranks.map((r) => (
