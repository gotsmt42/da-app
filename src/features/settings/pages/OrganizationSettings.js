...
const IMAGE_SLOTS = [
  {
    // ⚠️ เดิมชื่อช่องนี้ว่า "โลโก้แอป" ทั้งที่ของที่ใส่ได้คือโลโก้ "บริษัท" ด้วย — ชื่อช่องจึงบอก
    // ตำแหน่งที่ไปโผล่แทน (หัวเว็บ) ส่วนโลโก้ของแอปเป็นแค่ค่าเริ่มต้นที่ติดมาให้
    slot: "app", field: "logoUrl", title: "โลโก้บนหัวเว็บ",
    desc: "แสดงบนแถบบนทุกหน้าและหน้าเข้าสู่ระบบ · ค่าเริ่มต้นคือโลโก้ TidTam ของแอป — เลือกชุดที่ติดมากับแอปหรืออัปโหลดโลโก้บริษัททับได้",
    dark: true,
  },
  {
...
export default function OrganizationSettings() {
  ...
  /** เลือกรูปที่ติดมากับแอป (TidTam / ชุดเดิม) — เร็วกว่าไปหาไฟล์มาอัปโหลดใหม่ */
