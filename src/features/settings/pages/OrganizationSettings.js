...
const IMAGE_SLOTS = [
  {
    ...
    desc: "แสดงบนแถบบนทุกหน้าและหน้าเข้าสู่ระบบ · ค่าเริ่มต้นคือโลโก้ WiRix ของแอป — เลือกชุดที่ติดมากับแอปหรืออัปโหลดโลโก้บริษัททับได้",
    dark: true,
  },
  {
...
export default function OrganizationSettings() {
  ...
  /** เลือกรูปที่ติดมากับแอป (WiRix / ชุดเดิม) — เร็วกว่าไปหาไฟล์มาอัปโหลดใหม่ */
