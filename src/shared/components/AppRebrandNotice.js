...
const ACK_KEY = "app.rebrand.nexplan.ack";   // ⚠️ เปลี่ยนคีย์ทุกครั้งที่เปลี่ยนชื่อ/ไอคอน ไม่งั้นคนที่เคยกดรับทราบรอบก่อนจะไม่เห็นรอบใหม่
    ...
    <Box sx={{ px: { xs: 1.25, sm: 2 }, pt: 1.25 }}>
      ...
      >
        <Typography sx={{ fontWeight: 800, fontSize: "0.9rem" }}>
          แอปเปลี่ยนชื่อเป็น “NexPlan (เน็กซ์แพลน)” พร้อมไอคอนใหม่แล้ว
        </Typography>
