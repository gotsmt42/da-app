...
export const ORG_FALLBACK = {
   ...
   * ✅ ค่าเริ่มต้น = โลโก้ของ "แอป" (WiRix) ไม่ใช่โลโก้บริษัทใดบริษัทหนึ่ง — องค์กรที่เพิ่งติดตั้ง
...
/**
 * ชุดโลโก้ของแอป (WiRix) — มีหลายแบบเพราะพื้นหลังแต่ละที่ไม่เหมือนกัน
 ...
 * • ยังใช้ค่าเริ่มต้นของแอปอยู่ → หยิบไฟล์ WiRix ที่เข้ากับพื้นตรงนั้นให้อัตโนมัติ
