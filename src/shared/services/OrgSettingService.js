...
export const ORG_FALLBACK = {
   ...
   * ✅ ค่าเริ่มต้น = โลโก้ของ "แอป" (TidTam) ไม่ใช่โลโก้บริษัทใดบริษัทหนึ่ง — องค์กรที่เพิ่งติดตั้ง
...
/**
 * ชุดโลโก้ของแอป (TidTam) — มีหลายแบบเพราะพื้นหลังแต่ละที่ไม่เหมือนกัน
...
export const APP_LOGO = {
  ...
  stackedLight: "/app-logo-stacked-light.png", // เต็มชุด (เครื่องหมาย+ชื่อ+คำไทย) ตัวหนังสือขาว — แผงใหญ่พื้นเข้ม
 ...
 * • ยังใช้ค่าเริ่มต้นของแอปอยู่ → หยิบไฟล์ TidTam ที่เข้ากับพื้นตรงนั้นให้อัตโนมัติ
